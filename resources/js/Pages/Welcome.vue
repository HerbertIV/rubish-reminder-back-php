...
<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <Link v-if="$page.props.user" :href="route('schedules.index')" class="text-sm text-gray-700 dark:text-gray-500 underline">Schedules</Link>
            <Link v-if="$page.props.user" :href="route('users')" class="text-sm text-gray-700 dark:text-gray-500 underline">Users</Link>
            <Link v-if="$page.props.user" :href="route('regions')" class="text-sm text-gray-700 dark:text-gray-500 underline">Regions</Link>
